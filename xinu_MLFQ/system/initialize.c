...
static	void	sysinit()
{
	...
	// Initialize the stuff for the null process
	...
	//kprintf(" I am here");
	readylist = newqueue();
	readylist_user_high = newqueue();
	readylist_user_med = newqueue();
	readylist_user_low = newqueue();
