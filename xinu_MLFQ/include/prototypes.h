...
/* function for forking */ 

extern pid32 fork();

/* function for ready list */ 

extern syscall print_ready_list();

/* function to create a user process */ 

extern pid32 create_user_process(void *funcaddr, uint32 ssize, char *name, uint32 nargs,...);
...
/* Function: burst execution */ 

extern void burst_execution(uint32 number_bursts, uint32 burst_duratin, uint32 sleep_duration);

/* Function to set the ticket count */

extern void set_tickets(pid32 pid, uint32 tickets);

/* Function to dequeue a user function */ 

extern void dequeue_user(pid32 pid);

/* Function to add user list */

extern status insert_user(pid32 pid);

// Functions added for MLFQ

extern void insert_mlfq(pid32 pid);
